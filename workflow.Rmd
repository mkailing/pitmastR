...
### with **'integ_extract'**
The 'integ_extract' function may be beneficial for users that prefer to create a smaller object that contains detections from one reader/one file type.

'integ_extract' requires two arguments:
...
The integ_ids function allows users to combine metadata from individuals to detections. 

integ_ids requires three arguments:
